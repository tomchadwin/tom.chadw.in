...
void main() {
  gl_FragColor = vec4(1.0, 0.0, 0.0, 1.0);
		...
		indices.set(0, [0, 1, 2]);
		coords.set(0, [-16384, -16384, -16384]);
		coords.set(1, [-16384, +16384, +16384]);
		coords.set(2, [+16384, 0, 0]);
...
void main() {
  gl_FragColor = vec4(1.0, 0.0, 0.0, 1.0);
		...
		indices.set(0, [0, 1, 2]);
		coords.set(0, [-32767, -32767, 0]);
		coords.set(1, [-32767, -29490, 0]);
		coords.set(2, [-29490, -32767, 0]);
